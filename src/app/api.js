...
export async function get_user_guillds() {
    return await fetchWithRatelimit("GET", "/users/@me/guilds");
}

export async function get_user(user_id = "@me") {
    return await fetchWithRatelimit("GET", `/users/${user_id}`);
}
...
export async function get_guild_channels(guild_id) {
    return await fetchWithRatelimit("GET", `/guilds/${guild_id}/channels`);
}
...
export async function get_guild_member(guild_id, user_id) {
    ...
    return await fetchWithRatelimit("GET", `/guilds/${guild_id}/members/${user_id}`);
}
...
export async function get_guild_member_permissions(guild_id, user_id) {
    ...
    return await fetchWithRatelimit("GET", `/guilds/${guild_id}/members/${user_id}/permissions`);
}
...
export async function get_audit_log(
    ...
    while(entries.length < maximum) {
        ...
        let page = await fetchWithRatelimit("GET", `/guilds/${guild_id}/audit-logs?${query_params.join("&")}`);
